...
var _excluded = ["classes", "loading", "color", "logo", "backdrop", "role"];
...
var styles = theme => ({
  ...
  backdrop: {
    position: "absolute",
    zIndex: 2000,
    backgroundColor: (0, _colorManipulator.alpha)(theme.palette.background.default, 0.666)
  },
  backdropPrimary: {
    backgroundColor: (0, _colorManipulator.alpha)(theme.palette.primary.main, 0.666)
  },
  backdropSecondary: {
    backgroundColor: (0, _colorManipulator.alpha)(theme.palette.secondary.main, 0.666)
  },
  backdropPaper: {
    backgroundColor: (0, _colorManipulator.alpha)(theme.palette.background.paper, 0.666)
  },
  spinner: {
...
class LoadingScreen extends _react.default.Component {
  renderScreen() {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      src: logo
    })), loading && /*#__PURE__*/_react.default.createElement(_CircularProgress.default, _extends({}, rest, {
  ...
  render() {
    ...
    return backdrop ? /*#__PURE__*/_react.default.createElement(_Fade.default, {
      in: loading,
      timeout: {
        enter: 750,
        exit: 250
