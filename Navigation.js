...
function Navigation(props) {
  ...
  var navigationItems = _react.default.useMemo(() => apps.map(app => {
    ...
    return /*#__PURE__*/_react.default.createElement(_core.List, {
      ...
      subheader: app && showSubheader && multipleApps && !horizontal && /*#__PURE__*/_react.default.createElement(_core.ListSubheader, {
      ...
      return hidden !== true ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, {
        ...
        selected: isSelected,
        collapsed: collapsed
      }), Boolean(children && children.length) && /*#__PURE__*/_react.default.createElement(_core.Collapse, {
        in: isSelected
