...
var ErrorPage = _ref => {
  ...
  return /*#__PURE__*/_react.default.createElement(_AdminContext.default.Consumer, null, _ref2 => {
    var {
      admin,
      user
    } = _ref2;
    return /*#__PURE__*/_react.default.createElement(_CardPage.default, {
      title: title,
      subtitle: "Status: ".concat(statusCode || (0, _utils.t)("Unknown"))
    }, /*#__PURE__*/_react.default.createElement(_utils.Translate, {
      params: user
    }, statusCode >= 500 ? "There's been an error. It's been reported to the site administrators via email and should be fixed shortly. Thanks for your patience." : errorMessages[statusCode] || ""), statusCode === 403 && /*#__PURE__*/_react.default.createElement("div", {
