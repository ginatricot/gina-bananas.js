...
var _excluded = ["classes", "children", "disablePadding", "contained"];
...
class Content extends _react.default.Component {
  constructor(props) {
    super(props);
    this.scrollElement = /*#__PURE__*/_react.default.createRef();
  }
  ...
  render() {
    ...
    }, contained ? /*#__PURE__*/_react.default.createElement(_Container.default, null, /*#__PURE__*/_react.default.createElement("div", _extends({
...
_defineProperty(Content, "contextType", _AdminContext.default);
