...
class Messages extends _react.default.Component {
  render() {
    ...
    var snackbars = messages.map(msg => /*#__PURE__*/_react.default.createElement(BananasMessage, _extends({
      key: msg.id + msg.message
    }, msg)));
    return snackbars ? /*#__PURE__*/_react.default.createElement("div", {
...
class MessagesController extends _react.default.Component {
  ...
  dismissMessages() {
    ...
    if (openMessages.length) {
      this.setState({
        messages: this.state.messages.map(message => message.open ? _objectSpread(_objectSpread({}, message), {}, {
          open: false
        }) : message)
      });
    }
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(BananasMessages, {
      messages: messages
    });
  }
