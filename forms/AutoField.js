...
var _excluded = ["name", "fieldProps", "FieldComponent", "fieldsByType", "FinalFormFieldProps"];
...
class AutoField extends _react.default.Component {
  render() {
    ...
    var mergedFieldsByType = _objectSpread(_objectSpread(_objectSpread({}, fieldsByType), passedFieldsByType), {}, {
      string: _objectSpread(_objectSpread({}, fieldsByType.string), passedFieldsByType.string || {})
    });

    var fieldMapping = _objectSpread(_objectSpread({}, fieldsByType), mergedFieldsByType);

    var fieldType = schema.enum ? "enum" : schema.type;
    var fields = fieldMapping[fieldType] || fieldMapping.string;
    var {
      component,
      type
    ...
    return /*#__PURE__*/_react.default.createElement(_reactFinalForm.Field, _extends({
      ...
      return /*#__PURE__*/_react.default.createElement(Field, _extends({
        ...
        input: input,
        schema: schema,
        fieldProps: _objectSpread(_objectSpread({}, fieldProps), fieldPropsOverride)
      }, rest));
    });
  }
...
AutoField.propTypes = {
  ...
  fieldsByType: _propTypes.default.object,
  FinalFormFieldProps: _propTypes.default.object
};
