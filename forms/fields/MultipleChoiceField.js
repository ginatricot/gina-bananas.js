...
var MultipleChoiceField = _ref => {
  ...
  return /*#__PURE__*/_react.default.createElement(_core.FormControl, {
    ...
    htmlFor: "name-error"
  }, fieldProps.label), /*#__PURE__*/_react.default.createElement(_core.Select, _extends({}, input, {
    ...
    value: ""
  }, /*#__PURE__*/_react.default.createElement("em", null, "None")), schema.items.enum.map(value => /*#__PURE__*/_react.default.createElement(_core.MenuItem, {
    value: value,
    key: value
